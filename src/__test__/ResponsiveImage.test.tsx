...
describe('ResponsiveImage component', () => {
	it('renders without crashing', () => {
		const {getByAltText} = render(<ResponsiveImage image={mockPhotoProps} isMobile={true} isTablet={true} />);
	...
	it('renders with correct srcSet based on isMobile and isTablet props', () => {
		const {getByAltText} = render(<ResponsiveImage image={mockPhotoProps} isMobile={true} isTablet={false} />);
	...
	it('renders with correct sizes attribute based on isMobile and isTablet props', () => {
		const {getByAltText} = render(<ResponsiveImage image={mockPhotoProps} isMobile={false} isTablet={true} />);
		const imgElement = screen.getByAltText(mockPhotoProps.title) as HTMLImageElement;
